...
namespace SelectListIntro.Controllers
{
    ...
    // Attention 01 - View model for an "add new" form, Vehicle entity
    public class VehicleAddForm
    {
        ...
        // Attention 02 - Notice that the name of all SelectList properties have a "List" suffix
    ...
    // Attention 11 - View model for an "add new" form, Course entity
    ...
    // Attention 03 - View model class for a Manufacturer entity
    ...
    // Attention 04 - View model class for a Vehicle entity
    ...
    // Attention 12 - View model class for an Academic Term entity
    ...
    // Attention 13 - View model class for a Course entity
    public class Course
    {
        public int Id { get; set; }
