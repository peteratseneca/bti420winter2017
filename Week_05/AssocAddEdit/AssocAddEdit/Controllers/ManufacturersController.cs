...
namespace AssocAddEdit.Controllers
{
    public class ManufacturersController : Controller
    {
        ...
        // Attention 17 - Used "attribute routing" for a custom URL segment (resource)
        ...
        public ActionResult AddVehicle(int? id)
        {
            ...
            {
                // Attention 18 - Add vehicle for a known manufacturer
        ...
        // Attention 19 - Used "attribute routing" for a custom URL segment (resource)
        [Route("manufacturers/{id}/addvehicle")]
        [HttpPost]
        public ActionResult AddVehicle(VehicleAdd newItem)
        {
            ...
            {
                // Attention 20 - Must redirect to the Vehicles controller
