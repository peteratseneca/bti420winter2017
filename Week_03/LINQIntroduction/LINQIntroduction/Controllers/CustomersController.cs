...
namespace LINQIntroduction.Controllers
{
    public class CustomersController : Controller
    {
        ...
        // Attention 11 - New method that sorts (orders) the results
        ...
        // Attention 12 - New method pair that enables "search by country"
        ...
        // Attention 13 - New method pair that enables "search by name"
        // Uses a new view model class that holds the search term
        // The view was created with the "Create" template
