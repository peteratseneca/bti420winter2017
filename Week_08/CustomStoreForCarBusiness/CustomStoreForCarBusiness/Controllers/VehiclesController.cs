...
namespace CustomStoreForCarBusiness.Controllers
{
    ...
    public class VehiclesController : Controller
    {
        ...
        // Attention 31 - Vehicles controller, full functionality
        ...
        // GET: Vehicles/Create
        // Attention 32 - Allow a Manager to use this "add new" action/method pair
        ...
        // Attention 33 - Allow a Manager to use this "add new" action/method pair
        [Authorize(Roles = "Manager")]
        [HttpPost]
        ...
        // GET: Vehicles/Edit/5
        // Attention 33 - Can be edited by different kinds of users
        // Attention 34 - Comma-separated list of roles is an "OR" condition
        ...
        public ActionResult Edit(int? id)
        {
            ...
            else
            {
                ...
                var form = m.mapper.Map<VehicleEditForm>(o);
        ...
        // Attention 35 - Vehicle "delete item" is a more serious matter
        // Must be a vice-president who manages people and resources
        // Attention 36 - Stacked statements is an "AND" condition
