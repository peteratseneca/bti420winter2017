...
using TourOfTemplateV2CustomStore.Models;
...
namespace TourOfTemplateV2CustomStore.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        // Attention 16 - This is a new "Index" method in the account controller
        ...
        // ############################################################
        // Attention 17 - This is a new account details action/method
        ...
        {
            // ############################################################
            // Attention 11 - This Login() method's code was modified (to create an "admin" user)
        ...
        {
            // Attention 08 - Claims-aware "Register" method to display an HTML Form
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    // ############################################################
                    // Attention 09 - Claims-aware "Register" method to handle user-submitted data
                    ...
                    // Attention 10 - Register new user, role claims processing...
