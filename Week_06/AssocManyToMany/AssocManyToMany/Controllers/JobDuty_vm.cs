...
namespace AssocManyToMany.Controllers
{
    public class JobDutyBase
    {
        ...
        // Attention 21 - New property, composed name + description
    ...
    // Attention 22 - Edit employees with a job duty
    ...
    public class JobDutyEditEmployeesForm
    {
        ...
        // Attention 23 - Multiple select requires a MultiSelectList object
    ...
    public class JobDutyEditEmployees
    {
        ...
        // Attention 24 - Incoming collection of selected employee identifiers
