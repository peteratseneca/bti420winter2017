...
namespace AssocSelf.Controllers
{
    ...
    public class EmployeeBase
    {
        ...
        // Attention 11 - FullName composed property
    ...
    // Attention 12 - Edit the supervisor
    ...
    public class EmployeeEditSupervisorForm
    {
        ...
        // Attention 13 - SelectList for the supervisor
    ...
    public class EmployeeEditSupervisor
    {
        ...
        // Attention 14 - Identifier for the supervisor
    ...
    // Attention 21 - Edit the direct reports
    // Send this TO the HTML Form
    public class EmployeeEditDirectReportsForm
    {
        ...
        // Attention 22 - FullName composed property
        [Display(Name = "Employee name")]
        public string FullName
        {
            get
    ...
    public class EmployeeEditDirectReports
    {
        ...
        // Attention 25 - Collection of selected identifiers
